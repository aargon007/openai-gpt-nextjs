...
const page = () => {
    ...
    return (
        <div className="w-full h-full">
            <div role="presentation" className="h-full flex flex-col justify-center items-center gap-10">
                <div className="flex-1 overflow-hidden">
                    <div className="relative h-full">
                        {/* gpt model */}
                        {/* <div className="absolute  left-0 right-0">
                            <div className="sticky top-0 mb-1.5 flex items-center justify-between z-10 h-14  p-2 font-semibold bg-gray-800/90">
                                        ...
                                        <div className="mb-4 flex w-full grow gap-2 px-1 pb-1 sm:px-2 sm:pb-0 md:static md:mb-0 md:max-w-none">
                                            <div className="w-full grid grid-cols-2 gap-2">
                                                {featuresInput?.map((feature, index) =>
                                                    <div key={index} className="transform-none">
