...
const MainContainer = () => {
    return (
        <main className="relative h-full w-full flex-1 overflow-auto transition-width">
            {/* close sidebar */}
            <div className="fixed left-0 top-1/2 z-40 transform -translate-x-260 translate-y-[-50%] rotate-0">
                <button>
                    <span className="" data-state="closed">
                        <div className="flex h-[72px] w-8 items-center justify-center opacity-25">
                            <div className="flex h-6 w-6 flex-col items-center">
                                <div className="h-3 w-1 rounded-full bg-token-text-primary transform -translate-y-[0.15rem] rotate-0"></div>
                                <div className="h-3 w-1 rounded-full bg-token-text-primary transform translate-y-[-0.15rem] rotate-0"></div>
                            </div>
                        </div>
