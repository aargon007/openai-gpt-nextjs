...
const TopNav = () => {
    ...
    return (
        <div
            className="sticky border-b border-gray-500 lg:border-0 top-0 left-0 z-10 w-full flex items-center lg:h-14 px-4 transition-[left] duration-[0.25s] ease-in"
        ...
        >
            ...
            <div className="flex items-center justify-between pl-1 lg:hidden w-full text-gray-100">
                {/* open sidebar // onClick={() => setOpenMenu(!openMenu)} */}
                <button type="button" className="h-10 w-10 flex items-center justify-center transition-all hover:bg-[rgba(52,53,65,.5)] rounded-md">
                ...
                {/* new chat */}
                <button type="button" className="h-10 w-10 flex items-center justify-center transition-all hover:bg-[rgba(52,53,65,.5)]">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[18px] stroke-[1.5] block">
