    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between pl-1 lg:hidden w-full text-gray-100">
                ...
                <button onClick={() => setOpenMenu(!openMenu)} type="button" className="h-10 w-10 flex items-center justify-center transition-all hover:bg-[rgba(52,53,65,.5)] rounded-md">
