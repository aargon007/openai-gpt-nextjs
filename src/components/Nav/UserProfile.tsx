...
const UserProfile = () => {
    return (
        <Popover className="relative outline-none">
            ...
            <Popover.Panel className="w-full min-w-[300px] max-h-[300px] element-with-scrollbar z-[10] transition-all p-6 -ml-64 rounded-md mt-10 absolute top-0 text-center bg-white shadow-feedmenu-shadow">
                <div className="absolute bottom-full left-0 z-20 mb-1 w-full overflow-hidden rounded-lg border border-gray-100 bg-white pb-1.5 pt-1 outline-none dark:border-gray-800 dark:bg-gray-900 opacity-100 translate-y-0" role="menu">
                    <nav role="none">
                        <a className="flex px-3 min-h-[44px] py-1 items-center gap-3 dark:text-white cursor-pointer text-sm hover:bg-gray-100 dark:hover:bg-gray-800">
                        ...
                        <div className="h-px dark:bg-white/10 bg-black/20" role="none"></div>
                        <a className="flex px-3 min-h-[44px] py-1 items-center gap-3 dark:text-white cursor-pointer text-sm hover:bg-gray-100 dark:hover:bg-gray-800" id="headlessui-menu-item-:r9c:">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="icon-md">
